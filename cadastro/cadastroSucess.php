...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>noName - Cadastrado com Sucesso</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted font-13"> Você já pode entrar efetuar login com suas credenciais.</p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Efetuar<a href="../login/login.php" class="text-white ml-1"><b>Login</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
