            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card card-body" style="border-radius: 30px;">
                        ...
                        <label style="text-align: center;"><a href="?pagina=acompanhamento2" class="btn btn-success waves-effect waves-light" style="border-radius: 10px; width: 50%;">Consultar Avaliação</a></label>
                ...
                <div class="col-lg-4">
                    <div class="card card-body" style="border-radius: 30px;">
                        ...
                        <i class="mdi mdi-check-circle" style="text-align:right; color: #f7b84b; font-size: x-large;"data-toggle="tooltip" data-placement="right" data-original-title="Aguardando Correção"></i>
                        <div class="card-body">
                        ...
                        <label style="text-align: center;"><a href="?pagina=acompanhamento2" class="btn btn-warning waves-effect waves-light" style="border-radius: 10px; width: 50%;">Aguardando Correção</a></label>
