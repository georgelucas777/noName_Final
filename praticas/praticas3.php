            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card card-body" style="border-radius: 30px;">
                        ...
                        <i class="mdi mdi-check-circle" style="text-align:right; color: secondary; font-size: x-large;" data-toggle="tooltip" data-placement="right" data-original-title="Agendada"></i>
                        <div class="card-body">
                        ...
                        <label style="text-align: center;"><a href="?pagina=reservas" class="btn btn-secondary waves-effect waves-light" style="border-radius: 10px; width: 50%;">Consultar Agendamento</a></label>
